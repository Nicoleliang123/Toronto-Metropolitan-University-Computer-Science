#Midterm Practice - Redo of Questions
...
def calculator(op1, op2, operator):     
    ...
    #if the operator is +, return the addition of op1 and op2
    if operator == '+':
        return op1 + op2
    
    #otherwise, if operator is -, return the subtraction of op1 and op2
    elif operator == '-':
        return op1 - op2
    
    #otherwise, if operator is *, return the multiplication of op1 and op2
    elif operator == '*':
        return op1 * op2
    ...
    #otherwise, if operator is /
        ...
        #Check if division by zero occurs, meaning op2 == 0
        if op2 == 0:
            #Return no value
            return None
        
        #Otherwise, return the division of op1 and op2
        return op1 / op2  
    
    #otherwise, if operator is **, return the exponentiation of op1 and op2
    elif operator == '**':
        return op1 ** op2 
    
    #else, if operator is any other value not in the range of given test values
    else:
        #return no values
        return None